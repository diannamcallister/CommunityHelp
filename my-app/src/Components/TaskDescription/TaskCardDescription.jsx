        ...
        return (
            <div>
                ...
                <Card className='task-card'>
                    ...
                    <p className='text-center'><b className='subtitles'>Posted By: <Link className='link-color description' to={{pathname:'/UserProfile', state:{user:this.state.task.owner, userToView: this.state.task.owner}}}>{this.state.task.owner.name}</Link></b></p>
